...
export default function HomePage() {
  ...
  const organizationSchema = {
    ...
    url: siteConfig.url,
    logo: `${siteConfig.url}/brand/code4ce-logo-no-bg.png`,
    contactPoint: {
      "@type": "ContactPoint",
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative group max-w-md mx-auto lg:mx-0">
              ...
              <Image
                src="/brand/home.jpg"
                alt="CODE4CE - Software a medida que automatiza procesos e integra datos usando tecnología moderna e IA aplicada"
                width={400}
                height={300}
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.boxShadow =
                    "0 35px 60px -12px rgba(57, 0, 94, 0.3)";
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.boxShadow =
      ...
      <Section id="servicios" background="gray">
        <div className="text-center mb-12">
          ...
          <p className="max-w-2xl mx-auto" style={{ color: "#6B7280" }}>
            Soluciones tecnológicas personalizadas para resolver problemas
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="card group hover:border-teal-primary transition-all duration-300"
            >
              <div className="text-5xl mb-4 transform group-hover:scale-110 transition-transform duration-300">
                {service.icon}
              </div>
              <h3
                className="text-2xl font-semibold mb-3 transition-colors duration-300 group-hover:text-teal-primary"
                style={{ color: "#39005E" }}
              >
                {service.title}
              </h3>
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-0">
            ...
            {methodology.map((step, index) => {
              ...
              return (
                <div key={index} className="relative">
                  <div className="relative bg-white rounded-xl shadow-sm p-6 pl-20 sm:pl-28 hover:shadow-md transition-shadow duration-300">
                    {/* Indicador numerado */}
                    <div
          ...
          <div
            ...
            style={{
              ...
              width: "2px",
              background:
                "linear-gradient(to bottom, #9333EA 0%, #EC4899 25%, #EF4444 50%, #DC2626 75%, #F97316 100%)",
              zIndex: 1,
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                >
                  {(() => {
                    const IconComponent =
                      TechnologyIcons[
                        category.id as keyof typeof TechnologyIcons
                      ];
          ...
          {aboutUs.map((section, index) => (
            ...
            >
              <div className={index % 2 === 1 ? "lg:order-2" : ""}>
                <div className="relative group overflow-hidden rounded-xl shadow-xl max-w-md mx-auto lg:mx-0">
                  ...
                  <Image
                    ...
                    alt={`${section.title} - ${siteConfig.name}`}
                    width={400}
                    height={300}
                    className="rounded-xl transition-all duration-500 group-hover:scale-110 object-cover w-full"
                    quality={90}
                  />
                </div>
              </div>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          >
            ...
            >
              <Image
                src="/brand/email.jpg"
                alt="Icono de email - Contactar a CODE4CE"
                width={28}
                height={28}
